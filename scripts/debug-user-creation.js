...
async function debug() {
    ...
    if (process.env.DB_RESET_ON_DEPLOY === 'true') {
        console.error('CRITICAL WARNING: DB_RESET_ON_DEPLOY is true! The database might be wiped on deploy/restart.');
    }

    if (isDemo) {
        console.log('WARNING: System is running in DEMO MODE. Users will NOT be saved to DB.');
    }
