...
async function testCreateTechnician() {
    ...
    try {
        ...
        const userRes = await client.query(
            ...
            [name, email, hashedPassword, 'technician', '1234567890', cpfCnpj, false, true, new Date()]
        );
        ...
        const checkTech = await client.query('SELECT * FROM technicians WHERE user_id=$1', [userId]);
