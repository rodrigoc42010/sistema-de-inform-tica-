...
function Settings() {
  ...
  // Settings vêm do PreferencesProvider; não precisamos carregar aqui
  ...
  const handleAppearanceChange = (e) => {
    ...
    setSettings({
      ...settings,
      appearance: { ...settings.appearance, [e.target.name]: val },
    });
  };
  ...
  const handlePrivacyChange = (e) => {
    setSettings({
      ...settings,
      privacy: { ...settings.privacy, [e.target.name]: e.target.checked },
    });
  };
        ...
        <Container maxWidth="lg">
          ...
          <Box sx={{ mb: 6, position: 'relative', textAlign: 'center' }}>
            ...
            <Box sx={{ position: 'relative', zIndex: 1 }}>
              ...
              >
                Personalize sua experiência, notificações e preferências de
                privacidade.
              </Typography>
            </Box>
          </Box>
                ...
                <CardContent>
                  ...
                  <List dense disablePadding>
                    ...
                    <ListItem>
                      ...
                      <ListItemText
                        primary="Push"
                        secondary="Notificações no navegador"
                      />
                      <Switch
                        edge="end"
                        name="push"
                    ...
                    <ListItem>
                      ...
                      <ListItemText
                        primary="SMS"
                        secondary="Mensagens de texto urgentes"
                      />
                      <Switch
                        edge="end"
                        name="sms"
                  ...
                  <List dense disablePadding>
                    <ListItem>
                      <ListItemIcon>
                        <NewReleases sx={{ color: 'text.secondary' }} />
                      </ListItemIcon>
                        ...
                        <FormControl fullWidth size="small">
                          ...
                          >
                            <MenuItem value="light">
                              ...
                              >
                                <Visibility fontSize="small" /> Claro
                              </Box>
                            </MenuItem>
                            <MenuItem value="dark">
                              <Box
                  ...
                  <List dense disablePadding>
                    ...
                    <ListItem>
                      ...
                      <ListItemText
                        ...
                        secondary="Mostrar quando você está ativo"
                      />
                      <Switch
                        edge="end"
                    ...
                    <ListItem>
                      ...
                      <ListItemText
                        primary="Localização"
                        secondary="Usar localização para encontrar serviços"
                      />
                      <Switch
                        edge="end"
                  ...
                  <Stack spacing={2}>
                    ...
                    >
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          try {
                            await axios.post('/api/users/2fa/init');
                            toast.success(
                              'Código gerado, verifique seu e-mail/SMS ou app autenticador'
                            );
                          } catch (e) {
                    ...
                    >
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          try {
                            const r = await axios.get('/api/users/sessions');
                            const items = Array.isArray(r?.data?.items)
                              ? r.data.items.length
                              : 0;
                            toast.info(`Sessões ativas: ${items}`);
                          } catch (e) {
