...
function NearbyTechnicians() {
  ...
  const [technicians] = useState([
    {
      ...
      reviewCount: 124,
      distance: 2.3,
      services: ['Formatação', 'Instalação de Software', 'Remoção de Vírus', 'Troca de Tela de Celular', 'Troca de Bateria'],
      specialties: ['Windows', 'MacOS', 'Celulares'],
      available: true,
      phone: '(11) 98765-4321',
    ...
    },
    {
      ...
      reviewCount: 98,
      distance: 3.7,
      services: ['Reparo de Hardware', 'Backup de Dados', 'Configuração de Rede', 'Limpeza de Console', 'Troca de Pasta Térmica'],
      specialties: ['Hardware', 'Redes', 'Videogames'],
      available: true,
      phone: '(11) 91234-5678',
    ...
    },
    {
      ...
      reviewCount: 156,
      distance: 5.1,
      services: ['Montagem de Computador', 'Instalação de Periféricos', 'Consultoria', 'Reparo de Controles', 'Instalação de HD/SSD'],
      specialties: ['Hardware', 'Gaming', 'Videogames'],
      available: false,
      phone: '(11) 99876-5432',
    ...
    },
    {
      ...
      reviewCount: 112,
      distance: 6.8,
      services: ['Suporte Remoto', 'Instalação de Software', 'Treinamento', 'Reparo de Placa Mãe', 'Desbloqueio de Aparelho'],
      specialties: ['Windows', 'Office', 'Celulares'],
      available: true,
      phone: '(11) 98765-8765',
    ...
    },
    {
      ...
      reviewCount: 87,
      distance: 8.2,
      services: ['Recuperação de Dados', 'Formatação', 'Instalação de Sistemas', 'Recuperação de Dados Móveis', 'Desbloqueio de Console'],
      specialties: ['Recuperação de Dados', 'Linux', 'Celulares', 'Videogames'],
      available: true,
      phone: '(11) 99999-8888',
  ...
  const availableServices = [
    ...
    'Instalação de ROM/Firmware',
    'Reparo de Botões e Conectores',
    'Limpeza e Manutenção de Celular',
    'Recuperação de Dados Móveis',
    ...
    'Desbloqueio de Console',
    'Reparo de Leitor de Disco',
    'Configuração de Rede/Online',
    'Downgrade/Upgrade de Firmware',
  ];
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Container maxWidth={false} sx={{ 
          ...
          // alignItems removido para evitar centralização forçada
          maxWidth: '100%',
          width: '100%',
          px: { xs: 1, md: 2, lg: 3 }
        }}>
