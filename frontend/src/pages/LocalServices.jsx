...
function LocalServices() {
  ...
  const fetchServices = useCallback(
    async (location, customRadius = radius) => {
      if (!location) return;
      ...
      try {
        ...
        toast.error(
          'Erro ao carregar serviços locais. Verifique se o backend está rodando.'
        );
        setServices([]);
      } finally {
        setLoading(false);
  ...
  }, [radius, fetchServices, userLocation]);
  ...
  const handleWhatsApp = (phone, name) => {
    ...
    const text = encodeURIComponent(
      `Olá ${name}! Encontrei seu serviço no app e gostaria de mais informações.`
    );
                        ...
                        <Box>
                          ...
                          {service.phone && (
                            <IconButton
                              ...
                              color="success"
                              onClick={() =>
                                handleWhatsApp(service.phone, service.name)
                              }
                              title="WhatsApp"
                            >
                              <svg
                          ...
                          {service.email && (
                            <IconButton
                              ...
                              color="primary"
                              onClick={() =>
                                handleEmail(service.email, service.name)
                              }
                              title="Email"
                            >
